...
namespace eRestaurantSystem.BLL
{
    ...
    public class AdminController
    {
        ...
        public List<ReservationCollection> ReservationsByTime(DateTime date)
        {
            using (var context = new eRestaurantContext())
            {
                var result = (from data in context.Reservations//data is each row in reservation
                              ...
                              }).ToList(); //causes execution of the query so that the 
                                           //retrieved data is in memory
                var finalResult = from item in result
                                  orderby item.NumberInParty
                                  group item by item.Date.Hour into itemGroup //itemGroup
                                  //is a temporary data collection
